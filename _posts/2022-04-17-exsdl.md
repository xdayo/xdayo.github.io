...
对于任意大于4的自然数$n$，**求证**:$2^n\textgreater n^2$.

*证明*：$\because n\textgreater 4,\therefore2^n=(1+1)^n=C^0_n+C^1_n+C^2_n+\cdots+C^n_n=1+n+\frac {n(n-1)}2+\cdots+\frac{n(n-1)}2+n+1\geq n^2+n+2\textgreater n^2$
